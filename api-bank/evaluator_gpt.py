...
logging.basicConfig(
    filename='evaluator_gpt-4o-mini-2024-07-18.log', 
    filemode='w',    
    format='%(asctime)s - %(levelname)s - %(message)s',
    level=logging.INFO  
)
level = "level1"
output_file = f"/home/mony/DAMO-ConvAI2/api-bank/output/{level}/api_call_output_gpt-4o-mini-2024-07-18.jsonl"
...
if __name__ == '__main__':
    ...
    chatgpt = AIONEWrapper(api_key='YOUR_API_KEY')
            ...
            for sample_id in evaluator.get_all_sample_ids():
                ...
                if sample.ground_truth['role'] == 'API' and api_test_enabled:
                    ...
                    if not response or 'choices' not in response:
                        ...
                        model_output = response['choices'][0]['message']['content'] if isinstance(chatgpt, AIONEWrapper) else response['choices'][0]['text'].strip()
                    ...
                    if isinstance(chatgpt, AIONEWrapper):
